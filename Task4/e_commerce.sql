...
<head>
  ...
  <script type="text/javascript" src="http://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=At93FW1peSLwcXgfSlW2Q81W0fQDBPHCzlecIuoFJ8S8XFuKJL6bM31qUnNDgEHfaY1aoEnXHGO8SByCzmcQ_gHe-NLGvgSDsSSB-3je7Ig" charset="UTF-8"></script><style id="cfs-style">html{display: none;}</style>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3270692480ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=complain">`e_commerce`.`complain`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=users">`e_commerce`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=subcategories">`e_commerce`.`subcategories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=regions">`e_commerce`.`regions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=review">`e_commerce`.`review`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=products_specs">`e_commerce`.`products_specs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=products_offers">`e_commerce`.`products_offers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=products">`e_commerce`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=orders">`e_commerce`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e_commerce&table=fav">`e_commerce`.`fav`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3549577a2679326f246e523b3838285a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="e_commerce" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `users` ADD UNIQUE(`email`, `phone`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="admins">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="cities">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cities`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="addresses">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `addresses`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="regions">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `regions`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="categories">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `categories`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admins`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="brands">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `brands`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="categories">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cities`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="fav">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `fav`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="products_offers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products_offers`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="products_specs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products_specs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="regions">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `regions`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="review">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `review`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="e_commerce" targettable="subcategories">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="e_commerce" targettable="complain">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `e_commerce`.`complain` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,  `massages` TEXT NOT NULL ,  `user_id` BIGINT(20) UNSIGNED NOT NULL ,  `complain_id` BIGINT(20) UNSIGNED NOT NULL ,  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,  `updated_at` TIMESTAMP on update CURRENT_TIMESTAMP NULL DEFAULT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
