            ...
            <div class="tab-pane active">
                <div class="row">
                    ...
                    if ($products->num_rows >= 1) {
                        foreach ($products->fetch_all(MYSQLI_ASSOC) as $pro) {
                            if ($count == 4)
                                break;
                            $count++; ?>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6 mb-20">
                                ...
                                <div class="product-wrapper mb-60">
                                    <div class="product-img">
                                        <a href="product-details.php?product=<?= $pro['id'] ?>">
                                    ...
                                    <div class="product-content text-left">
                                        <div class="product-hover-style">
                                            <div class="product-title">
                                                <h4>
                                                    <a href="product-details.php?product=<?= $pro['id'] ?>"><?= $pro['name_en'] ?></a>
                                                </h4>
                                            </div>
                                            <div class="cart-hover">
                                                <h4><a href="product-details.php?product=<?= $pro['id'] ?>">+ Add to cart</a></h4>
                                            </div>
                                        </div>
